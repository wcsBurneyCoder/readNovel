...
- (NSInteger)dzn_itemsCount
{
    ...
    if ([self isKindOfClass:[UITableView class]]) {
        ...
        if ([self.emptyDataSetSource respondsToSelector:@selector(displayEmptyDataSet:)]) {
            BOOL res = ![self.emptyDataSetSource displayEmptyDataSet:self];
            return res?1:0;
        }
